...
if 'user' not in st.session_state:
  ...
  with col1:
    submit_button = login_form.form_submit_button(label='submit', use_container_width=True)
  with col2:
    register_button = login_form.form_submit_button(label='register', use_container_width=True)
